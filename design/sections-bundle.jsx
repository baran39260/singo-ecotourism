...
function Attractions() {
  const items = [
    { name: "دره ستارگان", dist: "۱۲ کیلومتر", desc: "صخره‌های مرموز که شب‌ها به ستاره می‌مانند", img: window.__resources.attr1 },
    { name: "جنگل حرا", dist: "۸ کیلومتر", desc: "بیشه‌ای روی آب", img: window.__resources.attr2 },
    { name: "غار خربس", dist: "۲۲ کیلومتر", desc: "غاری از دل صخره", img: window.__resources.attr3 },
    { name: "ساحل سیمیلان", dist: "۴ کیلومتر", desc: "ماسه نقره‌ای، آب فیروزه‌ای، شب‌های ساکت برای رصد و قدم زدن کنار ساحل بکر", img: window.__resources.attr4 },
  ];
  return (
...
function Addons() {
  const items = [
    { name: "صبحانه محلی قشمی", img: window.__resources.addon1, price: "۳۵۰٫۰۰۰", unit: "نفر / روز", ecoScore: "A", ecoReasons: ["مواد بومی", "بدون پلاستیک"] },
    { name: "تور قایق به جنگل حرا", img: window.__resources.addon2, price: "۱٫۲۰۰٫۰۰۰", unit: "هر قایق", ecoScore: "A", ecoReasons: ["راهنمای محلی", "بدون آلودگی صوتی"] },
    { name: "شام روی ساحل", img: window.__resources.addon3, price: "۸۵۰٫۰۰۰", unit: "نفر", ecoScore: "B", ecoReasons: ["غذای محلی"] },
    { name: "ترانسفر فرودگاه", img: window.__resources.addon4, price: "۴۰۰٫۰۰۰", unit: "یک طرفه", ecoScore: null },
  ];
  return (
    ...
    <section className="container section" id="about">
      <div className="story-grid">
        <div className="story-portrait">
          <img src={window.__resources.story} alt="مادربزرگ، بنیان‌گذار اقامتگاه"/>
        </div>
        <div>
...
function Blog() {
  const posts = [
    { cat: "راهنمای سفر", title: "۴۸ ساعت در قشم: راهنمای کامل سفر کوتاه", date: "۱۲ اردیبهشت ۱۴۰۵", time: "۸ دقیقه", img: window.__resources.blog1 },
    { cat: "آشپزی محلی", title: "دستور پخت سوراق، خوراک قشمی فراموش‌شده", date: "۸ اردیبهشت ۱۴۰۵", time: "۵ دقیقه", img: window.__resources.blog2 },
    { cat: "طبیعت", title: "جنگل حرا چرا روی آب می‌روید؟", date: "۲ اردیبهشت ۱۴۰۵", time: "۶ دقیقه", img: window.__resources.blog3 },
  ];
  return (
